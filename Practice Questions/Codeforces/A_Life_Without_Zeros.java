...
public class A_Life_Without_Zeros {
    ...
    private static void sagnik() throws IOException {
        ...
        int b = fs.nextInt();
        int c = a + b;
        int a1 = Integer.parseInt(String.valueOf(a).replaceAll("0",""));
        int b1 = Integer.parseInt(String.valueOf(b).replaceAll("0",""));
        int c1 = Integer.parseInt(String.valueOf(c).replaceAll("0",""));
        out.print(a1+b1 == c1 ? "YES" : "NO");
        out.flush();
    }
