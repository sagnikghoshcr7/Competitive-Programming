...
public class A_Sleuth {
    ...
    private static void sagnik() throws IOException {
        String s = fs.nextLine().replaceAll(" ","");
        out.println(isVowel(s.charAt(s.length()-2)) ? "YES" : "NO");
        out.flush();
    }
    ...
    private static boolean isVowel(char c) { return c=='a' || c=='A' || c=='e' || c=='E' || c=='i' || c=='I' || c=='o' || c=='O' || c=='u' || c=='U' || c == 'y' || c == 'Y';}
