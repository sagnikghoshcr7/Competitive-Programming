...
public class B_Rudolph_and_Tic_Tac_Toe {
    ...
    private static void sagnik() throws IOException {
        ...
        if (((a[0][0]==a[1][0] && a[1][0]==a[2][0])||(a[0][0]==a[0][1] && a[0][1]==a[0][2]) ||(a[0][0]==a[1][1] && a[1][1]==a[2][2])) && a[0][0]!='.') out.println((char) a[0][0]);
        else if (((a[0][1]==a[1][1] && a[1][1]==a[2][1]) || (a[1][0]==a[1][1] && a[1][1]==a[1][2]) || (a[2][0]==a[1][1] && a[1][1]==a[0][2])) && a[1][1]!='.') out.println((char) a[1][1]);
        else if (((a[0][2]==a[1][2] && a[1][2]==a[2][2]) || (a[2][0]==a[2][1] && a[2][2]==a[2][1])) && a[2][2]!='.') out.println((char) a[2][2]);
