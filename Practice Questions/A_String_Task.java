...
public class A_String_Task {
    ...
    private static boolean isVowel(char ch) { return (ch == 'a' || ch == 'e' || ch == 'i' || ch == 'o' || ch == 'u' || ch == 'A' || ch == 'E' || ch == 'I' || ch == 'O' || ch == 'U' || ch == 'y' || ch == 'Y'); }
    ...
    private static void solver() {
        ...
        for (int i=0; i<s.length(); i++) {
            if (!isVowel(s.charAt(i))) {
                sb.append("."); sb.append(Character.toLowerCase(s.charAt(i)));
            }
        }
