...
public class A_Pangram {
    ...
    private static int countNumGreaterInArr(int[] A, int n) { return (int) Arrays.stream(A).filter(x -> x >= n).count(); }
    ...
    private static void solver() {
        ...
        System.out.println(countNumGreaterInArr(map, 1) == 26 ? "YES" : "NO");
    }
}