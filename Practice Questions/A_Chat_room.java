...
public class A_Chat_room {
    ...
    private static void solver() {
        ...
        stack.push('o');stack.push('l');stack.push('l');stack.push('e');stack.push('h');
    ...
    // private static void solver() { // easy peasy regex
    //     System.out.print(sc.next().matches(".*h.*e.*l.*l.*o.*")?"YES":"NO");
    // }
}