...
public class A_Saturday {
    ...
    private static void sagnik() throws IOException {
        ...
        day.put("Monday", Integer.valueOf(5));
        day.put("Tuesday", Integer.valueOf(4));
        day.put("Wednesday", Integer.valueOf(3));
        day.put("Thursday", Integer.valueOf(2));
        day.put("Friday", Integer.valueOf(1));
        String S = fs.next();
        out.print(day.get(S));
        out.flush();
    }
