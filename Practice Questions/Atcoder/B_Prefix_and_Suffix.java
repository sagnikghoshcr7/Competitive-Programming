...
public class B_Prefix_and_Suffix {
    ...
    private static void sagnik() throws IOException {
        ...
        if (b.startsWith(a) && b.endsWith(a)) out.println(0);
        else if (b.startsWith(a) && !b.endsWith(a)) out.println(1);
        else if (!b.startsWith(a) && b.endsWith(a)) out.println(2);
        else out.println(3);
    }
