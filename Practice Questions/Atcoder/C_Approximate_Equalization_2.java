...
public class C_Approximate_Equalization_2 {
    ...
    private static void sagnik() throws IOException {
        ...
        // decrease Ai by 1 and increase Aj by 1
        // minimum number of operations required to make the difference between the minimum and maximum values ​​of A less than or equal to 1
        // match A with B when we have one B
        // Among B whose difference between the maximum value and the minimum value is 1 or less, the number of times obtained by 1 is the smallest
 
        // Let S be the sum of |A - B| If S is 0, A and B match.
 
        // the sum of the elements of B equals the sum of the elements of A
        // The difference between the maximum and minimum values ​​of B satisfies 1 or less
        // p is the quotient when the sum of the elements of A is divided by N, r is the remainder B is Nr p and r p+1
