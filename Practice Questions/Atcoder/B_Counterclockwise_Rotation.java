...
public class B_Counterclockwise_Rotation {
    ...
    private static void sagnik() throws IOException {
        double a = fs.nextDouble(), b = fs.nextDouble(), d = fs.nextDouble();

        double rad = Math.toRadians(d);
        out.print((a*Math.cos(rad) - b*Math.sin(rad)) + " " + (b*Math.cos(rad) + a*Math.sin(rad)));        
    }
